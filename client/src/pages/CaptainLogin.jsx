      ...
      <div className="h-screen w-full  px-5 py-7">
        ...
        >
          ...
          <button
            ...
            className="bg-amber-300 text-white pointer mt-6  px-3 py-1.5 text-md rounded-md w-full font-semibold
          md:w-[70%] md:text-[1.3rem] md:py-2.5 md:mt-7.5
           lg:py-3.5 lg:font-bold lg:mt-9 lg:w-1/2"
          >
            Sign in as User
          ...
          >
            New here?{" "}
            <Link to="/captain-signup" className="ml-1 text-blue-400 pointer">
              Register as Captain
            </Link>
          </h1>
        </form>
